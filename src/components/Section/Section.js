...
import { Tab, Row, Col, Nav, Card, CardGroup, Dropdown } from 'react-bootstrap';
          ...
          <div className='container my-4'>
            <Dropdown>
              ...
              <Dropdown.Menu>
                ...
                <Dropdown.Item onClick={handelerChanage} href="#/action-2" eventKey="second">Full Stack Web Development</Dropdown.Item>
                <Dropdown.Item onClick={handelerChanage} href="#/action-3" eventKey="third">Full Mobile App Development</Dropdown.Item>
                <Dropdown.Item onClick={handelerChanage} href="#/action-1" eventKey="four">DevOPS</Dropdown.Item>
                <Dropdown.Item onClick={handelerChanage} href="#/action-2" eventKey="five">Project Management</Dropdown.Item>
                <Dropdown.Item onClick={handelerChanage} href="#/action-3" eventKey="six">Cloud Technologies</Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          </div>
